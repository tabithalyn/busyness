...
const Hero = () => {
  ...
  return (
    <div className="grid grid-cols-1 p-20 mt-16 items-center z-20" id="HOME">
      <div className="mb-10">
      ...
      <div className="flex flex-wrap h-[90vh] gap-2">
        <div className="flex flex-[1] hover:flex-[2] h-1/3 w-[30%] p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 flex-wrap transition-all hover:cursor-default overflow-y-auto overflow-x-hidden">
